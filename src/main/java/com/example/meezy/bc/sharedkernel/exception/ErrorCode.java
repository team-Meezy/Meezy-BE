...
public enum ErrorCode {
    ...
    SIGNAL_SENDER_NOT_IN_MEETING(HttpStatus.FORBIDDEN, "시그널 발신자가 회의에 참가 중이 아닙니다."),
    ...
    PARTICIPATION_SENDER_NOT_IN_MEETING(HttpStatus.FORBIDDEN, "참여도 기록 요청자가 회의에 참가 중이 아닙니다."),
