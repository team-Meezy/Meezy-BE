...
import com.example.meezy.bc.user.user.application.port.out.EmailSenderPort;
import com.example.meezy.bc.user.user.application.port.out.EmailVerificationPort;
import com.example.meezy.bc.user.user.application.service.dto.request.SendVerificationRequest;
import com.example.meezy.bc.user.user.application.service.dto.request.VerifyEmailRequest;
import com.example.meezy.bc.user.user.application.service.dto.response.SendVerificationResponse;
import com.example.meezy.bc.user.user.application.service.dto.response.VerifyEmailResponse;
import com.example.meezy.bc.user.user.application.service.exception.DuplicateEmailException;
import com.example.meezy.bc.user.user.application.service.exception.InvalidVerificationCodeException;
import com.example.meezy.bc.user.user.application.service.exception.VerificationAttemptExceededException;
