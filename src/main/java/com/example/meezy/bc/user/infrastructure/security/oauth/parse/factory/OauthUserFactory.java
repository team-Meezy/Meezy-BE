package com.example.meezy.bc.user.infrastructure.security.oauth.parse.factory;
...
import com.example.meezy.bc.user.infrastructure.security.oauth.parse.google.GoogleOAuthUserInfoParser;
import com.example.meezy.bc.user.infrastructure.security.oauth.parse.kako.KakaoOAuthUserInfoParser;
import com.example.meezy.bc.user.infrastructure.security.oauth.parse.naver.NaverOAuthUserInfoParser;
